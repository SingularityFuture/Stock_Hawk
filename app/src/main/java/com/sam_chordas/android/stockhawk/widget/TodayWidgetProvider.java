...
public class TodayWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for(int appWidgetId : appWidgetIds){
            ...
            views.setRemoteAdapter(R.id.widget_list_view, new Intent(context, StockWidgetRemoteViewsService.class));
            ...
            appWidgetManager.updateAppWidget(new ComponentName(context, TodayWidgetProvider.class), views);
        }
